...
class Test_1056(unittest.TestCase):
    ...
    def test_1056(self):
        ...
        email = self.driver.find_element(By.ID,"usuario_registro_email").send_keys("lupi_747ive.com.ar")
        ...
        email.send_keys("lupi_747ive.com.ar")
